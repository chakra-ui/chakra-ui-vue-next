...
export function useFormControlProps<T extends VNodeProps>(
  ...
  return {
    ...
    isDisabled:
      disabled ?? isDisabled?.value
        ? isDisabled
        : field?.value?.isDisabled ?? field?.value?.isDisabled,
    isReadOnly:
      readOnly ?? isReadOnly?.value
        ? isReadOnly
        : field?.value?.isReadOnly ?? field?.value?.isReadOnly,
    isRequired:
      required ?? isRequired?.value
        ? isRequired
        : field?.value?.isRequired ?? field?.value?.isRequired,
    isInvalid: isInvalid?.value
      ? isInvalid
      : field?.value?.isInvalid ?? field?.value?.isInvalid,
