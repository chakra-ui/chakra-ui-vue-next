import { defineComponent, createVNode, mergeProps, isVNode, computed, Fragment, h } from 'vue';
...
var CBadge = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Badge', themingProps.value);
    return function () {
      return createVNode(chakra.div, mergeProps({
        "as": props.as,
        "__label": "badge",
...
var CCenter = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      }, props, attrs), _isSlot$b(slots) ? slots : {
        "default": function _default() {
          return [slots];
        }
      });
...
var CContainer = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Container', themingProps.value);
    return function () {
      return createVNode(chakra.div, mergeProps({
        "__label": "container",
...
var CDivider = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Divider', themingProps.value);
...
var CHeading = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Heading', themingProps.value);
    return function () {
...
var CLink = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Link', themingProps.value);
    return function () {
...
var CList = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      }, attrs), _isSlot$5(validChildren) ? validChildren : {
        "default": function _default() {
...
var CKbd = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Kbd', themingProps.value);
    return function () {
...
var CHStack = defineComponent({
  ...
  setup: function setup(props, _ref5) {
    var attrs = _ref5.attrs,
        slots = _ref5.slots;
    return function () {
      return createVNode(CStack, mergeProps({
...
var CText = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var styles = useStyleConfig('Text', themingProps.value);
...
var CWrap = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      return h(chakra(props.as, _extends({
        label: 'wrap'
      }, attrs)), {}, function () {
        return h(chakra('ul', {
          label: 'wrap__list',
...
export { CAspectRatio, CBadge, CBox, CCenter, CCircle, CContainer, CDivider, CGrid, CGridItem, CHStack, CHeading, CKbd, CLink, CLinkBox, CLinkOverlay, CList, CListIcon, CListItem, COrderedList, CSimpleGrid, CSpacer, CSquare, CStack, CStackDivider, CStackItem, CText, CUnorderedList, CVStack, CWrap, CWrapItem };
