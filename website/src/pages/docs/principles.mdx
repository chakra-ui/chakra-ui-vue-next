...
description: The principles that keep the Chakra UI components fairly consistent
version: 1.0+
---
...
To learn more about Chakra UI Vue, see the [Why Chakra UI page.](/docs/why-chakra-ui)
...
- **Dark Mode:** Make components dark mode compatible. Use `useColorMode` hook to handle styling.
  Learn more about dark mode. [Learn more about Dark mode](/docs/features/color-mode)
